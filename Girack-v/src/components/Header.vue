...
import ChannelConfig from "./ChannelWindowComponent/HeadComponents/ChannelConfig.vue";
import ChannelPin from "./ChannelWindowComponent/HeadComponents/ChannelPin.vue";
...
export default {
  setup() {
    ...
    return { mobile, myUserinfo, ChannelIndex, LIST_NOTIFICATION_MUTE_CHANNEL };
  },
