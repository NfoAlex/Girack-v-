  ...
  data() {
    return {
      ...
      actionameIndex: {
        ...
        channelEditScope: "チャンネルの公開状態を変更",
        ...
        >
          ...
          <v-expansion-panel-title>
            ...
            <span class="text-disabled" style="margin-right: 5%">
              {{ item.actionId.slice(0, 4) }}-{{ item.actionId.slice(4, 6) }}-{{
                item.actionId.slice(6, 8)
              }}
              {{ item.actionId.slice(8, 10) }}:{{
                item.actionId.slice(10, 12)
              }}:{{ item.actionId.slice(12, 14) }}
            </span>
          </v-expansion-panel-title>
          ...
          <v-expansion-panel-text>
            ...
            >
              ...
              <span
                v-if="
                  item.actionTo.type !== 'channel' &&
                  item.actionTo.type !== 'server'
                "
              >
                <!-- 矢印 -->
            ...
            <v-card color="cardInner" class="pa-3 rounded-lg">
              ...
              <p
                v-if="
                  item.actionInfo.valueBefore !== '' &&
                  item.actionInfo.valueAfter == ''
                "
                class="pa-2"
              >
                削除された
